...
export function Card({ icon: Icon, text, className }: CardProps) {
  return (
    <div
      className={`flex items-center gap-3 lg:gap-6 min-w-32 lg:min-w-72 h-10 lg:h-16 px-3 lg:px-5 rounded-[.625rem] lg:rounded-[1.25rem] bg-green-secondary animate-float ${className}`}
    >
